 ...
 | |_| | .  / ___ \\  _  | |_|  _  / 
  ...
  return (
    <div className="min-h-screen bg-black text-[#33ff00] font-mono glow-text selection:bg-[#33ff00] selection:text-black overflow-x-hidden relative">
      ...
      {!isBooting && (
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-10 bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(255,0,0,0.06),rgba(0,255,0,0.02),rgba(0,0,255,0.06))] bg-size-[100%_4px,3px_100%]"/>
      )}
